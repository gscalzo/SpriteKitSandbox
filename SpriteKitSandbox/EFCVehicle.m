...
//  SpriteKitSandbox
//
//  Created by Giordano Scalzo on 16/02/2014.
//  Copyright (c) 2014 Giordano Scalzo. All rights reserved.
//

#import "EFCVehicle.h"

@interface EFCVehicle ()
@property (nonatomic, copy)NSMutableArray *joints;
@property (nonatomic, strong)SKSpriteNode *ctop;
@property (nonatomic, strong)SKSpriteNode *leftWheel;
@end

@implementation EFCVehicle
